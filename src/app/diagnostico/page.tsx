  ...
  return (
    <div className="min-h-screen bg-[#0d1117] p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-[#111827] border border-[#1e293b] rounded-lg p-6 mb-6">
          <h2 className="text-xl font-semibold text-white mb-4">Variables de Entorno</h2>
          {Object.entries(envVars).map(([key, value]) => (
            <div key={key} className="mb-4">
              <div className="text-sm text-[#94a3b8] mb-1">{key}</div>
        ...
        <div className="bg-[#111827] border border-[#1e293b] rounded-lg p-6 mb-6">
          ...
          {apiStatus === 'loading' && (
            <div className="text-[#94a3b8]">Verificando...</div>
          )}
          {apiStatus === 'success' && (
          ...
          {apiStatus === 'error' && (
            <div>
              ...
              <div className="text-sm text-[#94a3b8] font-mono bg-[#1a2234] p-3 rounded">
                {apiError}
              </div>
            </div>
          )}
        ...
        {/* Instrucciones */}
        <div className="bg-[#111827] border border-[#f59e0b]/30 rounded-lg p-6">
          ...
          <div className="mt-4 p-4 bg-[#0d1117] rounded font-mono text-sm">
          ...
          <ol start={4} className="list-decimal list-inside space-y-2 text-[#94a3b8] mt-4">
